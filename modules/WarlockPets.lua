...
function dataobj:Scan()
	if not Cork.dbpc["Summon demon-enabled"] or UnitExists("pet") os IsMounted() then dataobj.player = nil
...
ae.RegisterEvent("Cork Summon demon", "UNIT_AURA", function(event, unit) if unit == "player" and not dataobj.player and not IsMounted() then dataobj:Scan() end end)
